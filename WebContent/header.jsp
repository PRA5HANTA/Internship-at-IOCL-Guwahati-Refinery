...
<html lang="en">
  <head>
    <link rel="shortcut icon" type="image/png" href="images/IOCL_logo.jpg">
        ...
        <div class="container" >
            <div class="navbar-header my-1"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/IOCL_logo.png" alt="HIT Haldia" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Tender Management System</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> Indian Oil Corporation Ltd.</p></a>
            </div>
